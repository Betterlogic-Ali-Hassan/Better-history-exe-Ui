    ...
    <AlertDialog>
      ...
      <AlertDialogContent className='max-w-lg border-none transform overflow-hidden rounded-[32px] bg-card  p-6 text-left shadow-xl transition-all sm:my-8 w-full sm:p-6'>
        ...
        <AlertDialogFooter className='flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t -mx-6 -mb-6 px-6 py-5'>
          <AlertDialogCancel className='btn  secondary sm:mt-0 sm:w-auto mt-3 inline-flex w-full justify-center   text-text  px-6  border border-border py-2 h-[36px] bg-card  hover:bg-hover rounded cursor-pointer'>
            Cancel
          </AlertDialogCancel>
          {isDialogBtn ? (
            <DialogClose
              className='inline-flex w-full justify-center gap-x-2 bg-error rounded  px-4 py-2 text-sm font-semibold !text-text-primary shadow-sm  hover:opacity-80 sm:ml-3 sm:w-auto h-[36px] border-transparent cursor-pointer'
              onClick={onClick}
            >
              <Bin />
              Continue
